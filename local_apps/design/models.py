...
class ChoreType(models.Model):
    ...
    traits_required = models.ManyToManyField(Trait, related_name="chores_requiring_trait")
    traits_forbidden = models.ManyToManyField(Trait, related_name="chores_forbidding_trait")
